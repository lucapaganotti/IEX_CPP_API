...
int main()
{
    ...
    std::cout << std::setw(2) << i << " Test stocks batch >>" << std::endl << test << std::endl;
    i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stocks::book("aapl");
    std::cout << std::setw(2) << i << " Test stocks book >>" << std::endl << test << std::endl;
    i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
	getchar();

    test = IEX::stocks::chart("aapl");
    std::cout << std::setw(2) << i << " Test stocks chart >>" << std::endl << test << std::endl;
    i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
	getchar();

    test = IEX::stocks::chartRange("aapl", "1m");
    std::cout << std::setw(2) << i << " Test stocks chart range >>" << std::endl << test << std::endl;
    i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stocks::chartDate("aapl", "20180801");
    std::cout << std::setw(2) << i << " Test stocks chart date >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stocks::chartDynamic("aapl");
    std::cout << std::setw(2) << i << " Test stocks chart dynamic >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stocks::company("aapl");
    std::cout << std::setw(2) << i << " Test stocks company >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stocks::delayedQuote("aapl");
    std::cout << std::setw(2) << i << " Test stocks delayed quote >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stocks::dividends("aapl", "5y");
    std::cout << std::setw(2) << i << " Test stocks dividends >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stocks::earnings("aapl");
    std::cout << std::setw(2) << i << " Test stocks earnings >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stocks::effectiveSpread("aapl");
    std::cout << std::setw(2) << i << " Test stocks effective spread >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::financials("aapl");
    std::cout << std::setw(2) << i << " Test financials >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::stats("aapl");
    std::cout << std::setw(2) << i << " Test stats >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::largestTrades("aapl");
    std::cout << std::setw(2) << i << " Test stocks largest trades >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::list("gainers");
    std::cout << std::setw(2) << i << " Test stocks list >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::logo("aapl");
    std::cout << std::setw(2) << i << " Test stocks logo >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::news("market", 5);
    std::cout << std::setw(2) << i << " Test stocks news market with parameter >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::news("market");
    std::cout << std::setw(2) << i << " Test stocks news market >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::news("aapl");
    std::cout << std::setw(2) << i << " Test stocks news <symbol> >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::OHLC("aapl");
    std::cout << std::setw(2) << i << " Test stocks OHLC <symbol> >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::OHLC("market");
    std::cout << std::setw(2) << i << " Test stocks OHLC market >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::peers("aapl");
    std::cout << std::setw(2) << i << " Test stocks peers >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::previous("aapl");
    std::cout << std::setw(2) << i << " Test stocks previous <symbol> >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::previous("market");
    std::cout << std::setw(2) << i << " Test stocks previous market >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::price("aapl");
    std::cout << std::setw(2) << i << " Test stocks price >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::quote("aapl");
    std::cout << std::setw(2) << i << " Test stocks quote <symbol> >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::quote("aapl", true);
    std::cout << std::setw(2) << i << " Test stocks quote <symbol> true >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::relevant("aapl");
    std::cout << std::setw(2) << i << " Test stocks relevant >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::sectorPerformance();
    std::cout << std::setw(2) << i << " Test stocks sector performance >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::splits("aapl","5y");
    std::cout << std::setw(2) << i << " Test stocks splits 5y >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::timeSeries("aapl");
    std::cout << std::setw(2) << i << " Test stocks time series >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test =  IEX::stocks::VolumeByVenue("aapl");
    std::cout << std::setw(2) << i << " Test stocks volume by venue >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::refData::symbols();
    std::cout << std::setw(2) << i << " Test refdata symbols >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::refData::corporateActions("20180907");
    std::cout << std::setw(2) << i << " Test refdata corporate actions <date> >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::refData::corporateActions();
    std::cout << std::setw(2) << i << " Test refdata corporate actions >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::refData::dividends("20180907");
    std::cout << std::setw(2) << i << " Test refdata dividends <date> >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::refData::dividends();
    std::cout << std::setw(2) << i << " Test refdata dividends >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::refData::nextDayExDate("20180907");
    std::cout << std::setw(2) << i << " Test refdata next day ex date <date> >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::refData::nextDayExDate();
    std::cout << std::setw(2) << i << " Test refdata next day ex date >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::refData::symbolDirectory("20180907");
    std::cout << std::setw(2) << i << " Test refdata symbol directory <date> >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::refData::symbolDirectory();
    std::cout << std::setw(2) << i << " Test refdata symbol directory >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stats::intraday();
    std::cout << std::setw(2) << i << " Test stats intraday >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stats::recent();
    std::cout << std::setw(2) << i << " Test stats recent >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stats::records();
    std::cout << std::setw(2) << i << " Test stats records >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stats::historical("20180907");
    std::cout << std::setw(2) << i << " Test stats historical >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stats::historicalDaily("20180907");
    std::cout << std::setw(2) << i << " Test stats historical daily <date> >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stats::historicalDaily("5");
    std::cout << std::setw(2) << i << " Test stats historical daily <parameter> >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stats::historicalDaily();
    std::cout << std::setw(2) << i << " Test refdata historical daily >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::markets::market();
    std::cout << std::setw(2) << i << " Test markets market >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stocks::crypto();
    std::cout << std::setw(2) << i << " Test stocks crypto >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stocks::earningsToday();
    std::cout << std::setw(2) << i << " Test stocks earnings today >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stocks::upcomingIPOS();
    std::cout << std::setw(2) << i << " Test stocks upcoming IPOS >>" << std::endl << test << std::endl;
	i++;
    std::cout << "Press ENTER to continue ..." << std::endl;
    getchar();

    test = IEX::stocks::todayIPOS();
    std::cout << std::setw(2) << i << " Test stocks today IPOS >>" << std::endl << test << std::endl;
	i++;
